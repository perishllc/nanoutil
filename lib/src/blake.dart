...
/// the class [Ed25519].
class DartEd25519Blake extends Ed25519 {
  final Blake2b _sha512;

  DartEd25519Blake({
    Blake2b? sha512,
    Random? random,
  })  : _sha512 = sha512 ?? Blake2b(),
  ...
  Future<SimplePublicKey> _publicKey(List<int> seed) async {
    ...
    DartEd25519Blake._setPrivateKeyFixedBits(tmp);

    // We get public key by multiplying the modified private key hash with G.
    final publicKeyBytes = DartEd25519Blake._pointCompress(DartEd25519Blake._pointMul(
